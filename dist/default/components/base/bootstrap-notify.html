...
<html lang="en" >
	...
	<head>
		<meta charset="utf-8" />
		<title>
			Metronic | Bootstrap Notify
		</title>
		<meta name="description" content="Bootstrap notify examples">
									...
									<div class="form-group m-form__group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<select class="form-control" id="m_notify_icon">
												...
												<option value="la la-cloud-download">
													la la-cloud-download
												</option>
												<option value="la la-warning">
													la la-warning
												</option>
												<option value="fa fa-warning">
													fa fa-warning
												</option>
												<option value="fa fa-cloud-download">
													fa fa-cloud-download
												</option>
												<option value="flaticon-exclamation-2">
													flaticon-exclamation-2
												</option>
												<option value="flaticon-signs">
													flaticon-signs
												</option>
											</select>
										</div>
									...
									<div class="m-form__actions m-form__actions">
										<div class="row">
											<div class="col-lg-9 ml-lg-auto">
												<a href="javascript:;" id="m_notify_btn" class="btn btn-success">
													Display
												</a>
...
<!-- begin::Footer -->
		...
		<script src="../../assets/demo/default/custom/components/base/bootstrap-notify.js" type="text/javascript"></script>
		<!--end::Page Resources -->
	</body>
	<!-- end::Body -->
</html>
