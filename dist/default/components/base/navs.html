...
<html lang="en" >
	...
	<head>
		...
		<meta name="description" content="Multi-purpose nav examples">
												...
												<div class="m-demo" data-code-preview="true" data-code-html="true" data-code-js="false">
													<div class="m-demo__preview">
														<ul class="m-nav">
															...
															<li class="m-nav__item m-nav__item--disabled">
																<a href="" class="m-nav__link">
																	<i class="m-nav__link-icon flaticon-info"></i>
																	<span class="m-nav__link-text">
																		Disabled
														...
														<div class="m-demo" data-code-preview="true" data-code-html="true" data-code-js="false">
															<div class="m-demo__preview">
																<ul class="m-nav m-nav--active-bg" id="m_nav" role="tablist">
																	...
																	<li class="m-nav__item m-nav__item--active">
																		<a class="m-nav__link"  role="tab" id="m_nav_link_1" data-toggle="collapse" href="#m_nav_sub_1" aria-expanded=" false">
																			<i class="m-nav__link-icon flaticon-chat-1"></i>
																			<span class="m-nav__link-title">
																				<span class="m-nav__link-wrap">
																					<span class="m-nav__link-text">
									...
									<div class="m-portlet__body">
										...
										<div class="m-section m-section--last">
											<span class="m-section__sub">
												Nav items can have dot and line style bullets:
											</span>
											<div class="m-section__content">
												<!--begin::Preview-->
												<div class="m-demo" data-code-preview="true" data-code-html="true" data-code-js="false">
												...
												<!--end::Preview-->
                        <!--begin::Dropdown-->
												<div class="m-dropdown m-dropdown--up m-dropdown--inline  m-dropdown--arrow" data-dropdown-toggle="click">
									...
									<div class="m-portlet__body">
										...
										<div class="m-section m-section--last">
											<div class="m-section__content">
												...
												<!--end::Preview-->
                        <!--begin::Dropdown-->
												<div class="m-dropdown m-dropdown--up m-dropdown--large m-dropdown--inline  m-dropdown--arrow" data-dropdown-toggle="click">
													<a href="#" class="m-dropdown__toggle btn btn-success dropdown-toggle">
														Dropdown example
													</a>
													<div class="m-dropdown__wrapper">
