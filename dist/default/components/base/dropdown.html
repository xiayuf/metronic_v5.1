...
<html lang="en" >
	...
	<head>
		...
		<meta name="description" content="Metronic dropdown examples">
					...
					<div class="m-content">
						<div class="row">
							<div class="col-lg-6">
								...
								<div class="m-section__content">
									<div class="m-dropdown m-dropdown--inline m-dropdown--arrow" data-dropdown-toggle="click" data-dropdown-persistent="true">
					...
					<div class="m-portlet">
						...
						<div class="m-portlet__body">
							...
							<div class="m-section">
								...
								<div class="m-section__content m-demo-dropdowns">
									<div id="m_dropdown_api_1" class="m-dropdown m-dropdown--inline m-dropdown--arrow" data-dropdown-toggle="hover">
										<a href="#" class="m-dropdown__toggle btn btn-primary dropdown-toggle">
											Dropdown 1
										</a>
										<div class="m-dropdown__wrapper">
									...
									<div id="m_dropdown_api_2" class="m-dropdown m-dropdown--inline m-dropdown--arrow" data-dropdown-toggle="click">
										<a href="#" class="m-dropdown__toggle btn btn-brand dropdown-toggle">
											Dropdown 2
										</a>
										<div class="m-dropdown__wrapper">
