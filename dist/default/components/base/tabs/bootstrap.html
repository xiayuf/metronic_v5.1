...
<html lang="en" >
	...
	<head>
		<meta charset="utf-8" />
		<title>
			Metronic | Bootstrap Tabs
		</title>
		<meta name="description" content="Bootstrap tabs examples">
										...
										<ul class="nav nav-tabs" role="tablist">
											...
											<li class="nav-item dropdown">
												...
												<div class="dropdown-menu">
													<a class="dropdown-item" data-toggle="tab" href="#m_tabs_1_2">
														Action
													</a>
													<a class="dropdown-item" data-toggle="tab" href="#m_tabs_1_2">
														Another action
								...
								<div class="m-portlet">
									...
									<div class="m-portlet__body">
										<ul class="nav nav-tabs" role="tablist">
											...
											<li class="nav-item dropdown">
												<a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
													<i class="la la-exclamation-circle m--font-success"></i>
													Dropdown
												</a>
												<div class="dropdown-menu">
													<a class="dropdown-item" data-toggle="tab" href="#m_tabs_1_2">
											...
											<li class="nav-item">
												<a class="nav-link" data-toggle="tab" href="#m_tabs_1_3">
													<i class="la la-puzzle-piece m--font-danger"></i>
													Link 2
												</a>
											</li>
											<li class="nav-item">
										...
										<ul class="nav nav-tabs" role="tablist">
											...
											<li class="nav-item dropdown">
												<a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
													<i class="flaticon-time-2 m--font-success"></i>
													Dropdown
												</a>
												<div class="dropdown-menu">
													<a class="dropdown-item" data-toggle="tab" href="#m_tabs_1_2">
											...
											<li class="nav-item">
												<a class="nav-link" data-toggle="tab" href="#m_tabs_1_3">
													<i class="flaticon-lock m--font-danger"></i>
													Link 2
												</a>
											</li>
											<li class="nav-item">
										...
										<ul class="nav nav-tabs" role="tablist">
											...
											<li class="nav-item dropdown">
												<a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
													<i class="fa fa-file-powerpoint-o m--font-success"></i>
													Dropdown
												</a>
												<div class="dropdown-menu">
													<a class="dropdown-item" data-toggle="tab" href="#m_tabs_1_2">
											...
											<li class="nav-item">
												<a class="nav-link" data-toggle="tab" href="#m_tabs_1_3">
													<i class="fa fa-comment m--font-brand"></i>
													Link 2
												</a>
											</li>
											<li class="nav-item">
								...
								<div class="m-portlet">
									...
									<div class="m-portlet__body">
										<ul class="nav nav-tabs nav-fill" role="tablist">
											...
											<li class="nav-item">
												<a class="nav-link" data-toggle="tab" href="#m_tabs_2_3">
													Link
												</a>
											</li>
											<li class="nav-item">
												<a class="nav-link disabled" data-toggle="tab" href="#m_tabs_2_4">
													Disabled
												</a>
											</li>
										</ul>
									...
									<div class="m-portlet__body">
										<ul class="nav nav-pills" role="tablist">
											...
											<li class="nav-item dropdown">
												...
												<div class="dropdown-menu">
													<a class="dropdown-item" data-toggle="tab" href="#m_tabs_3_2">
														Action
													</a>
													<a class="dropdown-item" data-toggle="tab" href="#m_tabs_3_2">
														Another action
											...
											<li class="nav-item">
												<a class="nav-link disabled" data-toggle="tab" href="#m_tabs_3_4">
													Disabled
												</a>
											</li>
										</ul>
									...
									<div class="m-portlet__body">
										<ul class="nav nav-pills nav-pills--success" role="tablist">
											...
											<li class="nav-item dropdown">
												...
												<div class="dropdown-menu">
													<a class="dropdown-item" data-toggle="tab" href="#m_tabs_4_2">
														Action
													</a>
													<a class="dropdown-item" data-toggle="tab" href="#m_tabs_4_2">
														Another action
											...
											<li class="nav-item">
												<a class="nav-link" data-toggle="tab" href="#m_tabs_4_3">
													Link 1
												</a>
											</li>
											<li class="nav-item">
